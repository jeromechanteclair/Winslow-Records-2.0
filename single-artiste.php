...
<div class="">
<div class="container-fluid " style="margin-bottom: 20px;padding-left: 0px;">
	<div class="col-sm-6"  ">
	...
	<div class="col-sm-6 " style="">
					...
					<div class="section2" style="margin:20px;background-color: red;">
	...
	<div class="row" id="contentartist">
		<div class="container">
			...
			<div class="col-sm-7 lefthero " style="">
				...
				<div style="background-image:url('<?php echo $thumbnail_url[0];?>');
				background-repeat: no-repeat;background-size: cover;background-position: center; height: 350px;margin-bottom: 20px;">
...
<div class="col-sm-12 marginbottom" style="">
						<h1 style="margin-top: 0px;"> <?php the_title(); ?> &nbsp</h1>
